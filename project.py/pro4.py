...
with col1:
    ...
    if iniReading and finReading:
            ...
            if finReading > iniReading:
                noOfUnits = finReading - iniReading
    ...
    if st.button("Calculate") and noOfUnits > 0:
        try:
          ...
          # For second 25 units
            ...
            total_cost = monthly_charges + units_cost

             # Add monthly charge
            row.append(["Monthly charge", "--", " --", monthly_charges])

            total_cost = round(units_cost + monthly_charges, 2)
